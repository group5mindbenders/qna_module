    ...
    function output(hello){
        ...
        if(hello.selectedValue=='Poll'){
            ...
            <label for="No">No</label>
             <br><br> &nbsp; &nbsp;
            <input type="button" id="studbut" value="submit" onClick="getPoll(this.form,'${mName}','${hello.msg}');this.disabled=true; this.value='submitted'">
            <br><br><br><br>
            ...
            <br><br>
            <input type="button" value="submit" id="subbtn" onClick="getQnA(this.form,'${mName}','${hello.msg}');this.disabled=true; this.value='submitted'">
            <br><br><br>
           <script src="user.js"><script>
            </form>`;
        }
